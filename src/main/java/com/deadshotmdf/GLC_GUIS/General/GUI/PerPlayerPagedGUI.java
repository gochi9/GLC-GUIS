...
public abstract class PerPlayerPagedGUI<S extends AbstractGUIManager, T> extends PerPlayerGUI<S> {
    ...
    public PerPlayerPagedGUI(GuiManager guiManager, S correspondentManager, String title, int size, Map<Integer, Map<Integer, GuiElement>> pageElements, GUI backGUI,  UUID viewer, Object... args) {
    ...
    public void refreshInventory() {
        ...
        while (iterator.hasNext()) {
            ...
            pageInventories.computeIfAbsent(++currentPage, _ ->
