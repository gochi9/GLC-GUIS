...
public class PerPlayerGUI<T extends AbstractGUIManager> extends AbstractGUI<T> {
    ...
    public PerPlayerGUI(GuiManager guiManager, T correspondentManager, String title, int size, Map<Integer, Map<Integer, GuiElement>> pageElements, GUI backGUI, UUID viewer, String... args) {
